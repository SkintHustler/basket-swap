...
export const qr_title = css`
  display: flex;
  flex-direction: row;
  align-items: center;
`;

export const qr_float = css`
  width: 100%;
  height: 0;
  display: flex;
  flex-direction: column;
