...
export const _basket_maker = css`
  position: absolute;
...
export const _search = css`
  min-width: 100%;
  width: 100%;
  padding: 0 48px 8px 48px;
`;

export const _list = css`
  width: 100%;
  height: 100%;
  display: flex;
  flex-direction: column;
...
export const _tokens = css`
  width: 100%;
  margin-right: 6px;
`;

export const _add = css`
  width: 100%;
  margin-left: 6px;
  > button {
    width: 100%;
