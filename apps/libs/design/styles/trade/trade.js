...
export const trade_wrapper = css`
  pointer-events: all;
  position: relative;
  z-index: ${({ theme }) => theme.zindex.swap.container};
  min-width: 100%;
...
export const trade_actions = css`
  min-width: 100%;
  width: 100%;
  display: flex;
  flex-direction: row;
...
export const trade_chevron = css`
  min-height: 100%;
  height: 100%;
  display: flex;
  flex-direction: row;
...
export const trade_content = css`
  position: relative;
  display: flex;
  flex-direction: row;
  justify-content: center;
